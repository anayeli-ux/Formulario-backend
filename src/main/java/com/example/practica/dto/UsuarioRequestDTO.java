...
public class UsuarioRequestDTO {
    ...
    // estado y municipio YA NO se reciben del cliente —
    // el backend los calcula a partir del codigoPostal usando PostaliaService.
    ...
    @NotBlank(message = "El animal favorito es obligatorio")
    @Size(max = 50, message = "El animal favorito no puede superar 50 caracteres")
